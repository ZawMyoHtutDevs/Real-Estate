...
@extends('admin.layouts.app', ['page_action' => 'Type List'])
@section('style')
<!-- page css -->
...
<div class="page-header">
    <h2 class="header-title">Type List</h2>
...
<div class="row">
    <div class="col-md-4">
        <div class="card">
            <div class="card-header mt-3 h4">{{ __('Add New Type') }}</div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.types.store') }}" >
                    ...
                    <div class="form-group">
                        <input type="text" name="name" id="name" class="form-control  @error('name') is-invalid @enderror" placeholder="Type Name" value="{{ old('name') }}" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="slug" id="slug" class="form-control  @error('slug') is-invalid @enderror" placeholder="type-slug" value="{{ old('slug') }}" >
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- Edit and View --}}
                                    <a href="{{route('admin.types.edit', $data->id)}}" class="btn btn-icon btn-hover btn-sm btn-rounded pull-right text-primary">
                                    ...
                                    <form style="display: none;" id="delete-form{{$data->id}}" method="POST" action="{{route('admin.types.destroy', $data->id)}}" >
                                        @csrf @method('DELETE')
                                    </form>
