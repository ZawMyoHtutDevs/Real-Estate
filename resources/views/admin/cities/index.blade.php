...
@extends('admin.layouts.app', ['page_action' => 'City List'])
@section('style')
<!-- page css -->
...
<div class="page-header">
    <h2 class="header-title">City List</h2>
...
<div class="row">
    <div class="col-md-4">
        <div class="card">
            <div class="card-header mt-3 h4">{{ __('Add New City') }}</div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.cities.store') }}" >
                    ...
                    <div class="form-group">
                        <input type="text" name="name" id="name" class="form-control  @error('name') is-invalid @enderror" placeholder="City Name" value="{{ old('name') }}" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="slug" id="slug" class="form-control  @error('slug') is-invalid @enderror" placeholder="category-slug" value="{{ old('slug') }}" >
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- Edit and View --}}
                                    <a href="{{route('admin.cities.edit', $data->id)}}" class="btn btn-icon btn-hover btn-sm btn-rounded pull-right text-primary">
                                    ...
                                    <form style="display: none;" id="delete-form{{$data->id}}" method="POST" action="{{route('admin.cities.destroy', $data->id)}}" >
                                        @csrf @method('DELETE')
                                    </form>
